...
async def showdown(current_game, current_round):
    ...
    if len(current_round.caller) == 0:
        ...
        current_game.chips[winner] += 2 if current_game.current_round != 6 else 4
    else:
        ...
        current_game.chips[winner] += len(current_round.caller) + 1 if current_game.current_round != 6 else len(current_round.caller) * 2 + 2
